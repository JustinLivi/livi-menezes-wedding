...
export const WhereToStayDetails: React.SFC = () => (
  <GridLayout>
    <StandardCard>
      ...
      <p>Call (407) 745-3477. We are under the “Livi Menezes Wedding Block.”</p>
      <p />
      <p>
      ...
      <p>2. Select the Check-In and Check-Out dates at the top of the page.</p>
      <p>
        3. Select the Discounts drop-down menu and enter the group code MENE1011
        to verify.
      </p>
      ...
      <p>
        If you have any questions about where to stay in Baltimore, feel free to
        reach out! We are happy to provide suggestions/advice!
      </p>
    </StandardCard>
  </GridLayout>
);
